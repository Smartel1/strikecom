...
class EventIndexResource extends Resource
{
    ...
    public function toArray($request)
    {
        $structure = [
            ...
            'conflict_id'      => $this[0]->getConflictId(),
            'event_status_id'  => $this[0]->getEventStatusId(),
            'event_type_id'    => $this[0]->getEventTypeId(),
            ...
            'conflict'         => ConflictDetailResource::make($this[0]->getConflict()),
