 ...
 */
class ConflictReason extends \App\Entities\References\ConflictReason implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConflictReason $proxy) {
