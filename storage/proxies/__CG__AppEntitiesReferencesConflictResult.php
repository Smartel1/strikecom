 ...
 */
class ConflictResult extends \App\Entities\References\ConflictResult implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name_ru', 'name_en', 'name_es'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConflictResult $proxy) {
